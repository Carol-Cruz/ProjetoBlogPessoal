...
public class UsuarioControllerTest {
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService
				.cadastrarUsuario(new Usuario(0L, "Rodrigo", "rodrigo@email.com.br", "rodrigo123", "-"));

		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Rodrigo Santos",
				"rodrigosantos@email.com.br", "rodrigo123", "-");
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Carol Kruz", "carol@email.com.br", "carol123", "-"));

		usuarioService.cadastrarUsuario(new Usuario(0L, "Lucas Zehyr", "lucas@email.com.br", "lucas123", "-"));
